...
#ifndef BP32_ESP32_GAMEPAD_H
#define BP32_ESP32_GAMEPAD_H
...
#include "Esp32GamepadProperties.h"
...
class Gamepad {
   ...
   private:
    ...
    int8_t _idx;
    esp32_gamepad_data_t _data;
    esp32_gamepad_properties_t _properties;
